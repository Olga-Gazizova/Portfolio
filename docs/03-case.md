...
Базой послужил существующий продукт компании для подписи документов.
...
2. **Сценарии использования**
    ...
    Далее мы выделили пять основных групп действий и прописали юз-кейсы:
...
Приложение создавалось на основе существующего продукта, поэтому я использовала компоненты его дизайн-системы и основные паттерны взаимодействия.
