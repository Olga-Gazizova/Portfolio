...
slug: "/post1"
title: "Интерфейс для СКУД"
metaTitle: "Интерфейс для СКУД"
sort: "1"
...
2. **Таблицы**.
    ...
    На данном этапе моей задачей было определить основные требования к таблицам. По всем вопросам я контактировала с проджект-менеджером.
...
### 3. Первая итерация согласований
...
> **Дисклеймер.** Я не упоминаю про контекстное меню и действия с группами в боковой панели. Я рассматривала эту функциональность, но для первой версии системы было решено от нее отказаться.
...
### 6. Проработка форм для создания объектов
...
### 7. Проработка форм для просмотра объектов
...
### 8. Вторая итерация согласований
